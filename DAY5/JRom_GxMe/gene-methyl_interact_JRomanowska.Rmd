...
The development of a relatively cheap technology to measure DNA methylation levels on a genome-wide scale led to an explosion in the amount of studies that used these on the samples from individuals they had access to.
...
After the first wave of excitement has calmed down, we now see that what we're left with is a plethora of data without really insightful, complete conclusions.
...
- find the SNP-CpG pairs associated with a trait _(mQTL)_
...
The most interesting is the search for mQTL, so a pair of SNP and CpG where the methylation level is dependent on the allele of the SNP.
...
> Addon package for Haplin to manage and prepare DNAm data    
https://github.com/jromanowska/HaplinMethyl
...
- only CpGs within certain genomic regions    
...
- CpGs within *promoter*, *enhancer*, or *gene body* regions    
...
<br>
HaplinMethyl: https://github.com/jromanowska/HaplinMethyl
